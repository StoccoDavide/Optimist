...
#ifndef OPTIMIST_SCALAR_FUNCTION_SIN_HH
#define OPTIMIST_SCALAR_FUNCTION_SIN_HH
...
namespace Optimist
{
  ...
  namespace TestSet
  {
    ...
    */
    ...
    class Sin : public ScalarFunction<Real, Sin<Real>>
    {
    public:
...
#endif // OPTIMIST_SCALAR_FUNCTION_SIN_HH
