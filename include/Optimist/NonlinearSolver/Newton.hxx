    ...
    */
    bool solve(Vector const &x_ini, Vector &x_sol) override
    {
      ...
      for (this->m_iterations = Integer(1); this->m_iterations < this->m_max_iterations; ++this->m_iterations)
      {
        ...
        OPTIMIST_ASSERT(this->m_lu.rank() == N, "Optimist:Newton::solve(...): singular Jacobian detected.");
    ...
    */
    bool solve_damped(Vector const &x_ini, Vector &x_sol) override
    {
      ...
      for (this->m_iterations = Integer(1); this->m_iterations < this->m_max_iterations; ++this->m_iterations)
      {
        ...
        // Calculate step
        this->m_lu.compute(jacobian);
        OPTIMIST_ASSERT(this->m_lu.rank() == N, "Optimist:Newton::solve_damped(...): singular Jacobian detected.");
