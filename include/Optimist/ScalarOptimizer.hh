...
#ifndef OPTIMIST_SCALAR_OPTIMIZER_HH
#define OPTIMIST_SCALAR_OPTIMIZER_HH
  ...
  */
  namespace ScalarOptimizer
  {
    ...
    */
    ...
    class ScalarOptimizer : public Solver<Real, 1, 1, DerivedSolver>
    {
    public:
      friend Solver<Real, 1, 1, ScalarOptimizer<Real, DerivedSolver>>;
...
#endif // OPTIMIST_SCALAR_OPTIMIZER_HH
