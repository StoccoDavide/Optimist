if (OPTIMIST_ENABLE_PLOTTING)
  ...
  message(STATUS "Optimist: Found Root installed in ${ROOT_INCLUDE_DIRS}")

  if(NOT TARGET ROOT::Core OR NOT TARGET ROOT::Gpad)
    message(STATUS "Optimist: Did not find Root ${ROOT_REQUIRED_VERSION} installed, please "
  ...
  message(STATUS "Optimist: Root plotting disabled")
endif()
