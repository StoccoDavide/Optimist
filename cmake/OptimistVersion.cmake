function(parse_version_string VERSION_STRING)
  ...
  set(OPTIMIST_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(OPTIMIST_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(get_version_from_git)
  ...
  set(OPTIMIST_VERSION "0.0.0" CACHE INTERNAL "")
  set(OPTIMIST_VERSION_PRERELEASE "" CACHE INTERNAL "")
endfunction()

function(write_version_file)
  if(NOT OPTIMIST_VERSION)
    message(FATAL_ERROR "OPTIMIST_VERSION is not set")
  endif()

  set(VERSION_STRING "${OPTIMIST_VERSION}")
  if(OPTIMIST_VERSION_PRERELEASE)
    set(VERSION_STRING "${VERSION_STRING}-${OPTIMIST_VERSION_PRERELEASE}")
  endif()
