...
list(APPEND CMAKE_PATH_PREFIX "${OPTIMIST_THIRD_PARTY_DIR}")
find_package(
  GTest
...
if(NOT TARGET GTest::gtest)
  message(STATUS "Optimist: Did not find GTest ${GTEST_REQUIRED_VERSION} installed, downloading to "
  ...
  message(STATUS "Optimist: Found GTest installed in ${GTEST_INCLUDE_DIRS}")
endif()
