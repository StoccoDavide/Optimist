...
namespace Optimist {
  ...
  namespace TestSet {
     ...
     * \f]
     * The function has a zero at \f$x = 0\f$, with \f$f(x) = 0\f$. The initial
     * guesses are generated on the range \f$x \in \left[-10, 10\right]\f$.
...
#endif  // OPTIMIST_TESTSET_SINH_HH
