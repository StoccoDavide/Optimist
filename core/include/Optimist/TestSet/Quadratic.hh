...
namespace Optimist {
  ...
  namespace TestSet {
     ...
     * \f]
     * The default coefficients are \f$a = 1\f$, \f$b = 1\f$, and \f$c = -1\f$,
     * and the function initial guess is \f$x = 0\f$.
    ...
    class Quadratic : public Function<Scalar, Scalar, Quadratic<Scalar>> {
     ...
     public:
       ...
       */
      Quadratic() {
        Scalar delta{static_cast<Scalar>(
            std::sqrt(this->m_b * this->m_b - 4.0 * this->m_a * this->m_c))};
        this->m_solutions.emplace_back((-this->m_b + delta) /
                                       (2.0 * this->m_a));  // Zero
        this->m_solutions.emplace_back((-this->m_b - delta) /
                                       (2.0 * this->m_a));  // Zero
        this->m_solutions.emplace_back(-this->m_b /
                                       (2.0 * this->m_a));  // Minimum
